...
const CommentsForm = ({slug}) => {
  ...
  const handleCommentSubmitssion = () => {
    setError(false)
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className="grid grid-cols-1  gap-4 mb-4">
        <textarea className='p-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700' ref={commentEl} cols="30" rows="10" placeholder='Comment' name='comment' />
      </div>
      ...
      <div className='mt-8'>
        <button 
          type='button' 
          onClick={handleCommentSubmitssion} 
